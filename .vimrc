...
fun SetupVAM()
  ...
  call vam#ActivateAddons(['BufOnly', 'EasyMotion', 'LustyJuggler', 'matchit.zip', 'pylint', 'The_NERD_Commenter', 'trailing-whitespace', 'UltiSnips', 'utl', 'github:gotgenes/vim-yapif'], {'auto_install' : 0})
endfun
call SetupVAM()
